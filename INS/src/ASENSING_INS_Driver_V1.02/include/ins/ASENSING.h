// Generated by gencpp from file ins/ASENSING.msg
// DO NOT EDIT!


#ifndef INS_MESSAGE_ASENSING_H
#define INS_MESSAGE_ASENSING_H
...
struct ASENSING_
{
  ...
  typedef boost::shared_ptr< ::ins::ASENSING_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::ins::ASENSING_<ContainerAllocator> const> ConstPtr;

}; // struct ASENSING_

typedef ::ins::ASENSING_<std::allocator<void> > ASENSING;

typedef boost::shared_ptr< ::ins::ASENSING > ASENSINGPtr;
typedef boost::shared_ptr< ::ins::ASENSING const> ASENSINGConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::ins::ASENSING_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::ins::ASENSING_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::ins::ASENSING_<ContainerAllocator1> & lhs, const ::ins::ASENSING_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::ins::ASENSING_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ins::ASENSING_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ins::ASENSING_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ins::ASENSING_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ins::ASENSING_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ins::ASENSING_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::ins::ASENSING_<ContainerAllocator> >
{
  ...
  static const char* value(const ::ins::ASENSING_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x71cc4b05e9f3e6f3ULL;
  static const uint64_t static_value2 = 0x66c4fb6f4c0ec4edULL;
};

template<class ContainerAllocator>
struct DataType< ::ins::ASENSING_<ContainerAllocator> >
{
  static const char* value()
  {
    return "ins/ASENSING";
...
template<class ContainerAllocator>
struct Definition< ::ins::ASENSING_<ContainerAllocator> >
{
  static const char* value()
  {
    return "\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::ins::ASENSING_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::ins::ASENSING_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ins::ASENSING_<ContainerAllocator>& v)
  {
    s << indent << "latitude: ";
